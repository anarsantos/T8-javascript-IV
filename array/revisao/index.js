...
// Append adiciona direto no array

// concat faz a cópia do array e adiciona o elemento que a gente passa como argumento, não adiciona inofrmação ao elemento original
...
// shift - remove o primeiro item do array e retorna qual ele arrancou, modifica permanentement o array
console.log(comidas.shift());
console.log(comidas);

// pop - arranca o último item do array e retorna o que ele deletou, modifica permanentemente o array
console.log(comidas.pop());
console.log(comidas);

// Adiciona um item na primeira posição do array, modifica permanentemente o array
comidas.unshift("Macarrão")
console.log(comidas);

// Adiciona um item na última posição do Array, modifica permanentemente o array
...
// slice (começo, final) - faz uma cópia simples delimitando o começo e o final da parte que eu quero
let cortarAlimentos = comidas.slice(1, 2)
console.log(cortarAlimentos);
console.log(comidas);

// Pode remover e adicionar valores utilizando posição, indice de apagar
comidas.splice(1, 0, "Alface")
console.log(comidas);

// Coloca a lista em ordem, primeiro as maiúsculas e depois as minúsculas
comidas.sort()
console.log(comidas);
...
// pega o primeiro valor da esquerda para direita
console.log(comidas.indexOf("Batata"));
console.log(comidas.lastIndexOf("Batata"));
// Não encontrou
console.log(comidas.indexOf("Brócolis"));
